...
type CPU struct {
	...
	Brand         string  `protobuf:"bytes,1,opt,name=brand,proto3" json:"brand,omitempty"`                                       // Intel, AMD
	Name          string  `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`                                         // Core i7-9320, etc
	NumberCores   uint32  `protobuf:"varint,3,opt,name=number_cores,json=numberCores,proto3" json:"number_cores,omitempty"`       // can not be negative
	NumberThreads uint32  `protobuf:"varint,4,opt,name=number_threads,json=numberThreads,proto3" json:"number_threads,omitempty"` // can not be negative
	MinGhz        float64 `protobuf:"fixed64,5,opt,name=min_ghz,json=minGhz,proto3" json:"min_ghz,omitempty"`                     // can also be float
